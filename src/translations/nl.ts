...
export const nl = {
  ...
  'Consularity transformed our entire business operations. Their implementation was smooth and their ongoing support has been exceptional.': 
    'Consularity heeft onze volledige bedrijfsvoering getransformeerd. Hun implementatie verliep soepel en hun doorlopende ondersteuning is uitzonderlijk.',
  ...
  'We\'re a team of technology experts dedicated to transforming businesses through innovative AI, cloud, and ERP solutions.': 
    'Wij zijn een team van technologie-experts die zich toeleggen op het transformeren van bedrijven door middel van innovatieve AI-, cloud- en ERP-oplossingen.',
  ...
  'At Consularity, we combine deep technical expertise with business acumen to deliver transformative technology solutions that drive tangible results for our clients.': 
    'Bij Consularity combineren we diepgaande technische expertise met zakelijk inzicht om transformatieve technologische oplossingen te leveren die tastbare resultaten opleveren voor onze klanten.',
  'We believe that the convergence of AI, cloud technology, and business systems creates unprecedented opportunities for businesses of all sizes.': 
    'We geloven dat de samenvloeiing van AI, cloudtechnologie en bedrijfssystemen ongekende mogelijkheden creëert voor bedrijven van alle groottes.',
  'Our mission is to make these cutting-edge technologies accessible and valuable to small and midsize enterprises, helping them compete and thrive in an increasingly digital world.': 
    'Onze missie is om deze geavanceerde technologieën toegankelijk en waardevol te maken voor kleine en middelgrote ondernemingen, zodat zij kunnen concurreren en floreren in een steeds digitalere wereld.',
  ...
  'We strive for excellence in everything we do, from code quality to client communication.': 
    'We streven naar uitmuntendheid in alles wat we doen, van codekwaliteit tot communicatie met klanten.',
  'Innovation': 'Innovatie',
  'We constantly explore new technologies and approaches to deliver the best solutions.': 
    'We verkennen voortdurend nieuwe technologieën en benaderingen om de beste oplossingen te leveren.',
  'Client Success': 'Klantsucces',
  'Our success is measured by the success of our clients. We\'re partners in your journey.': 
    'Ons succes wordt gemeten aan het succes van onze klanten. We zijn partners in uw reis.',
  'Our Journey': 'Onze Reis',
  'Company Founded': 'Bedrijf Opgericht',
  ...
  'International Expansion': 'Internationale Uitbreiding',
  'Expanded our services to new regions, helping more businesses leverage the power of technology.': 
    'Breidde onze diensten uit naar nieuwe regio\'s, waardoor meer bedrijven gebruik kunnen maken van de kracht van technologie.',
  
  // Contact Page
  'Have questions? Ready to start your digital transformation? Get in touch with our team.': 
    'Heeft u vragen? Klaar om uw digitale transformatie te starten? Neem contact op met ons team.',
  'Send us a message': 'Stuur ons een bericht',
  'Name': 'Naam',
  'Your name': 'Uw naam',
  'Email': 'E-mail',
  'your.email@example.com': 'uw.email@voorbeeld.com',
  'Subject': 'Onderwerp',
  'How can we help?': 'Hoe kunnen we helpen?',
  'Message': 'Bericht',
  'Tell us about your project or inquiry...': 'Vertel ons over uw project of vraag...',
  'Send Message': 'Bericht Versturen',
  'Contact Information': 'Contactinformatie',
  'Phone': 'Telefoon',
  'Office Hours': 'Kantooruren',
  'Monday - Friday:': 'Maandag - Vrijdag:',
  '9:00 AM - 6:00 PM CET': '9:00 - 18:00 uur CET',
